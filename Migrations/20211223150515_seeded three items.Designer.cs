...
namespace SneakersFootprint.Migrations
{
    ...
    [Migration("20211223150515_seeded three items")]
    partial class seededthreeitems
    {
            ...
            modelBuilder.Entity("SneakersFootprint.Models.Sneaker", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SneakerId = 1,
                            CategoryId = 1,
                            ImageThumbnailUrl = "~/Images/sko-air-huarache-le-7ggQkX",
                            ImageUrl = "~/Images/sko-air-huarache-le-7ggQkX",
                            InStock = true,
